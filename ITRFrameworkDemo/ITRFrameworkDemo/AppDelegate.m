...
//  ITRFrameworkDemo
//
//  Created by kiruthika selvavinayagam on 3/4/16.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSBundle *bundle = [NSBundle bundleWithPath:[[NSBundle mainBundle] pathForResource:@"ITRStaticLibrary" ofType:@"bundle"]];
    UIImage *assetImage  = [UIImage imageNamed:@"asset_background" inBundle:bundle compatibleWithTraitCollection:nil];
    
    UIImage *image = [UIImage imageNamed:@"ITRStaticLibrary.bundle/background"];
    _itrAirSideMenu.backgroundImage = assetImage;
